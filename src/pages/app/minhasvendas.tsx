...
const MinhasVendas = () => {
    ...
    const generateStats = (data: Sale[] | null | undefined) => {
        ...
        const total_discount = data.reduce((acc, curr) => acc + curr.discount, 0)
        const total_sell_price = (total_weight_price + total_unit_price) - total_discount

        const averagePrice = total_sell_price === 0 ? 0 : total_sell_price / qtd_sales
